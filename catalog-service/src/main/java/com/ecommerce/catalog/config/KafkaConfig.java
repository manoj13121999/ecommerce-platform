...
public class KafkaConfig {
    ...
    @Bean
    ConsumerFactory<String, OrderPaidEvent> orderPaidConsumerFactory() {
        ...
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, OrderPaidEvent.class.getName());
        return new DefaultKafkaConsumerFactory<>(config);
    }

    @Bean
    ConcurrentKafkaListenerContainerFactory<String, OrderPaidEvent> orderPaidKafkaListenerContainerFactory() {
